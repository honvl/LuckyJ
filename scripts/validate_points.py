...
def build() -> dict[str, Any]:
    ...
    points = [
        ...
        point(
            ...
            "The point must stay narrow: who is the tile for, and when will it be spent?",
        ...
        point(
            ...
            [
                pattern(patterns, "threat_keep_exit", "Named threat tile", "対象付き安全牌"),
                pattern(patterns, "multi_threat_safe_tenpai", "Multiple-threat tile", "多件脅威安全牌"),
