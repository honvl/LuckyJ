...
PUBLISHED: dict[str, tuple[float, str]] = {
    ...
    "yakuhai_threat_yes": (40.0, "condition_effects_child_only.yakuhai_pon.requested_cells.existing_table_threat.yes.pon_rate_pct"),
    "yakuhai_threat_no": (83.0, "condition_effects_child_only.yakuhai_pon.requested_cells.existing_table_threat.no.pon_rate_pct"),
