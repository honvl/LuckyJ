...
.venv/bin/python scripts/mine_rx3_defense.py  # child-only push rates by threat class
.venv/bin/python scripts/mine_rx3_riichi.py   # child-only declare thresholds and keiten pushes
