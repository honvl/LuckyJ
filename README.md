...
The raw NAGA report cache, Mortal repo checkout, model weights, Mjai logs, and local hand-review source files are intentionally not committed. The report cache is about 1.2 GB and can be regenerated by rerunning the analyzer.
