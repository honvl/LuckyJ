...
The raw NAGA report cache and local hand-review source files are intentionally ignored by git. The report cache is about 1.2 GB and can be regenerated by rerunning the analyzer.
